...
export default function QueueView({ banner, mode, localStream, videoError, onBack }) {
  return (
    <div className="d-flex flex-column align-items-center justify-content-center flex-grow-1 text-center">
      ...
      <button className="btn btn-outline-secondary mt-4" onClick={onBack}>Cancel</button>
    </div>
  );
}
